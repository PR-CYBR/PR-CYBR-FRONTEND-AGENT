# ----------------------------------------------------------------------------
# Reference template showing the expected Terraform Cloud variable wiring for
# PR-CYBR agents.  These expressions intentionally reference Terraform Cloud
# variables so that no secrets or identifiers are stored in the repository.
# ----------------------------------------------------------------------------
